...
<!-- Showcase 2-4 top projects with compelling one-liners -->
...
<!--
**Pro Tips:**
- Replace placeholder links and usernames with your own.
- Update your banner image in the assets folder or use your own.
- Add more relevant sections as you grow (Certifications, Blog, Talks, etc).
-->
